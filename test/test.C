...
int test(Long64_t max_entries = 1e4, Long64_t first_entry = 0) {
  ...
  // TString file_list = "Mu2eEvtAna/file_lists/nts.mu2e.CeEndpointMix1BBTriggered.MDC2025-000.root.files";
  TString file_list = "Mu2eEvtAna/file_lists/nts.mu2e.CosmicSignalOnSpillTriggered.MDC2025-001.root.files";
  ...
  gAna->load_baskets_ = false; // whether or not to load tree baskets when a new file is opened
